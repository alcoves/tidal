    ...
    ffmpeg.ffprobe(videoPath, (err, metadata) => {
      ...
      if (width >= 1280) {
        selectedPresets.push({
          ...
          ffmpegCmdStr: presets['libx264-720p'].join(' '),
        });
      }
      ...
      if (width >= 1920) {
        selectedPresets.push({
          ...
          ffmpegCmdStr: presets['libx264-1080p'].join(' '),
        });
      }
      ...
      if (width >= 2560) {
        selectedPresets.push({
          ...
          ffmpegCmdStr: presets['libx264-1440p'].join(' '),
        });
      }
      ...
      if (width >= 3840) {
        selectedPresets.push({
          ...
          ffmpegCmdStr: presets['libx264-2160p'].join(' '),
        });
      }
