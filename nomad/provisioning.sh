...
# Nomad Leaders
sudo cp /mnt/tidal/dev/nomad/server.service /etc/systemd/system/nomad-server.service
sudo systemctl enable nomad-server.service
sudo systemctl start nomad-server.service

# Nomad Workers
sudo cp /mnt/tidal/dev/nomad/client.service /etc/systemd/system/nomad-client.service
