...
sudo cp /root/tidal/nomad/config/client.service /etc/systemd/system/nomad-client.service
sudo cp /root/tidal/nomad/config/server.service /etc/systemd/system/nomad-server.service
